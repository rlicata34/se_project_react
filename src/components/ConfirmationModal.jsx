...
function ConfirmationModal({ activeModal, modalRef, onClose, handleCardDelete }) {
    ...
    return ( 
        <div className={`modal ${activeModal === "confirm" && "modal_opened"}`} id="confirmation-modal">
            <div className="modal__content modal__content_type_confirm " ref={modalRef} >
                ...
                <button className="modal__delete-button" onClick={handleCardDelete} >Yes, delete item</button>
